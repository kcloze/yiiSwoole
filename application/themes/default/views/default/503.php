	...
	<div class="wrapper fn-clear">
		<div class="err-box fn-clear">
			<div class="err-txt fn-left">
				...
				<p><img src="/static/gonglv/images/404-img1.png" width="329" height="189"></p>
				<p></p>
				<p class="p2">系统自动跳转在  <span class="time" id="time"><?php echo $data['times'];?></span>  秒后，如果不想等待，<a href="<?php echo $data['url'];?>">点击这里跳转</a></p>
...
<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1000490903'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1000490903' type='text/javascript'%3E%3C/script%3E"));</script>
</html>